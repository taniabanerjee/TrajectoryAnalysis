...
query="select track_id, x+0.5*w, y+0.5*h, class, BinPhase from TrackInfo t1 inner join SPAT t2 on t1.timestamp = t2.timestamp order by track_id asc, frame_id asc;"
